...
function myPopups() {
  ...
  const time = parentContainer.dataset.popupSpeed
    ? Number(parentContainer.dataset.popupSpeed)
    : 500;
...
function mySelects() {
  ...
  selects.forEach((select) => {
    select.addEventListener("click", (e) => {
      ...
      if (option) {
        ...
        if (
          option.getAttribute("data-select-option") &&
          selected.getAttribute("data-select-selected")
        ) {
  ...
  document.addEventListener("click", (e) => {
    ...
    selects.forEach((select) => {
      if (
        !elementTarget.closest("[data-select-button]") &&
        !elementTarget.closest("[data-select-dropdown]")
      ) {
        removeClass(select);
      }
    });
